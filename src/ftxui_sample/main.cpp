...
// configuration step. It creates a namespace called `MyMonsterWar`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", MyMonsterWar::cmake::project_name, MyMonsterWar::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", MyMonsterWar::cmake::project_version);
      return EXIT_SUCCESS;
    }
